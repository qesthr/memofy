  ...
  <header class="navbar">
    <div class="navbar-content">
      ...
      <div class="navbar-right">
        ...
        <!-- Profile Dropdown -->
        <div class="dropdown dropdown-end">
          <div tabindex="0" role="button" class="admin-badge cursor-pointer">
            <div class="avatar online">
              <div class="w-8 h-8 rounded-full bg-primary text-primary-content flex items-center justify-center overflow-hidden">
                ...
                <span v-else class="text-xs font-semibold">{{ getInitials(user?.full_name || 'Admin') }}</span>
              </div>
            </div>
            <div class="hidden sm:flex flex-col items-start ml-2">
              <span class="text-xs font-bold text-primary leading-none">Admin</span>
