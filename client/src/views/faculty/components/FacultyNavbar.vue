      ...
      <div class="navbar-right">
          ...
          <div tabindex="0" class="dropdown-content z-[1] mt-3 w-80 card card-compact bg-base-100 shadow-xl border border-base-300">
            <div class="card-body">
              ...
              <div class="card-actions">
                <button class="btn btn-secondary btn-block btn-sm">View all</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="dropdown dropdown-end">
          ...
          <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow-xl bg-base-100 border border-base-300 rounded-box w-52 mt-3">
            ...
            <li><router-link to="/faculty/settings"><User :size="16" /> Profile</router-link></li>
            <li><router-link to="/faculty/settings"><Settings :size="16" /> Settings</router-link></li>
